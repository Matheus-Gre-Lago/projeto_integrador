 ...
 * @author 55519
 */
public class EventoEditar extends javax.swing.JFrame {

    /**
     * Creates new form EventoEditar
     */
    public EventoEditar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setMaximumSize(new java.awt.Dimension(85, 16));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventoEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventoEditar().setVisible(true);
            }
        });
    }
